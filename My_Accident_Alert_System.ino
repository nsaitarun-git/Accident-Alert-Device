...
//Function to check for sim card
void gsmSimCheck(){
  clearScreen();
  display.setCursor(5,25);
...
//Function to connect GSM module to mobile network 
...
//Function to get accelerometer readings
void accReadings(){
 ...
 //Function to calibrate the accelerometer and get accurate readings
 void accCalibration(){
 ...
 //Function setup and get GPS information
 void gpsData(){
